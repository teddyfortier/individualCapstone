...
<body>
    ...
    <main role="main" id="main-content">
        ...
        <!--<div class="container">
            <a href="../Capstone Files/calendar.html" class="button">Schedule a Fire Drill</a><br><br>
            <a href="#" class="button">View Upcoming Fire Drills</a><br><br>
            <a href="#" class="button">List of IU Buildings</a><br><br>
            <a href="importance.html" class="button">Importance of Fire Drills</a><br><br>
          </div>
          !-->
          ...
          <ul class="menu">
            ...
            <li><a href="login.php" class="button">Admin Login</a></li>
          </ul>
        </div>
